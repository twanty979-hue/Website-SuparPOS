    ...
    <div className="w-full max-w-md md:max-w-xl xl:max-w-md mx-auto min-h-screen pb-32 relative overflow-x-hidden font-sans text-[#3E2723]">
        ...
        {selectedProduct && (
            <div className="fixed inset-0 z-[100] flex items-end md:items-center xl:items-end justify-center bg-[#3E2723]/80 backdrop-blur-sm animate-in fade-in duration-300">
                <div className="w-full max-w-md md:max-w-xl xl:max-w-md bg-white border-t-8 border-x-8 border-[#F50057] max-h-[90vh] md:max-h-[85vh] xl:max-h-[90vh] shadow-[0_-10px_0_#C51162] rounded-t-[3rem] md:rounded-2xl xl:rounded-none xl:rounded-t-[3rem] animate-in slide-in-from-bottom duration-300 flex flex-col overflow-hidden">
                    ...
                    <div className="flex-1 overflow-y-auto no-scrollbar px-8 pt-8 pb-6 relative bg-[#FCE4EC]">
                            ...
                            {selectedProduct.options && selectedProduct.options.length > 0 && (
                                <div className="space-y-5">
                                    {selectedProduct.options.map((opt: any, groupIndex: number) => (
                                        <div key={groupIndex} className="bg-white border-4 border-[#4DD0E1] rounded-2xl p-4 shadow-[4px_4px_0_#B2EBF2]">
                                            <label className="block text-lg font-bold text-[#3E2723] mb-3 bubbly-font ml-1 tracking-wide flex items-center justify-between">
                                                <span>{opt.name}</span>
                                                {opt.required ? (
                                                    <span className="text-[#F50057] bg-white border-2 border-[#F50057] px-2 py-0.5 rounded text-[10px] tracking-widest font-black pixel-font">REQUIRED</span>
                                                ) : (
                                                    <span className="text-[#4DD0E1] bg-white border-2 border-[#4DD0E1] px-2 py-0.5 rounded text-[10px] tracking-widest font-black pixel-font">OPTIONAL</span>
                                                )}
                                            </label>
                                            <div className="grid grid-cols-3 gap-2">
                                                {opt.choices.map((choice: any) => {
                                                    ...
                                                    return (
                                                        <button
                                                            ...
                                                            className={`p-2 rounded-xl border-4 transition-all flex flex-col items-center justify-between min-h-[100px] bubbly-font
                                                                ${isSelected
                                                                    ? 'bg-[#FFEB3B] border-[#FBC02D] shadow-[3px_3px_0_#F57F17] -translate-y-1 text-[#3E2723]'
                                                                    : 'bg-white border-[#F8BBD0] text-[#F48FB1] hover:border-[#F50057] hover:text-[#F50057]'}`}
                                                        >
                                                            {choiceImage ? (
                                                                <div className="w-12 h-12 rounded-lg overflow-hidden border-2 border-white mb-2 bg-[#E0F7FA] shrink-0">
                                                                    <img
                                                            ...
                                                            <span className="text-xs font-black text-center line-clamp-2 flex-1 flex items-center justify-center w-full leading-tight">
                                                                {choice.name}
                                                            </span>
                                                            <span className="text-xs font-bold leading-none mt-1 text-[#F50057]">
                    ...
                    <div className="shrink-0 w-full p-5 md:p-6 bg-[#FCE4EC] border-t-4 border-[#F50057] grid grid-cols-2 gap-4 z-30">
        ...
        {activeTab === 'cart' && (
             <div className="fixed inset-0 z-[100] flex items-end justify-center bg-[#3E2723]/80 backdrop-blur-sm animate-in fade-in duration-300">
                 <div className="w-full max-w-md md:max-w-xl xl:max-w-md mx-auto bg-[#FFF] border-t-8 border-[#F50057] flex flex-col shadow-[0_-10px_0_#C51162] h-[85vh] md:h-[80vh] xl:h-[85vh] rounded-t-[3rem] md:rounded-2xl xl:rounded-none xl:rounded-t-[3rem] animate-in slide-in-from-bottom duration-300 relative">
                     {/* Decorative Elements */}
