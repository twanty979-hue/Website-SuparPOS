      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-10 mb-12">
        ...
        <div>
          ...
          <ul className="space-y-2.5 text-sm">
            ...
            <li><a href="https://img.pos-foodscan.com/downloads/SuparPOS-Setup-v2.1.1.exe" download="SuparPOS-Setup-v2.1.1.exe" className="hover:text-emerald-400 transition-colors">Windows PC Installer</a></li>
          </ul>
        </div>
