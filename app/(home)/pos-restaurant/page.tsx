...
export const metadata: Metadata = {
  title: "โปรแกรมร้านอาหาร ระบบรับออเดอร์และจอครัว | POS Foodscan",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "โปรแกรมร้านอาหาร ระบบรับออเดอร์และจอครัว | POS Foodscan",
      },
    ],
  },
  twitter: {
...
const RESTAURANT_FAQS = [
  {
    ...
    answer: "POS Foodscan สามารถตั้งค่าแยกเครื่องพิมพ์ตามหมวดหมู่เมนูได้ครับ เช่น เมื่อมีการจิ้มสั่งออเดอร์อาหารและน้ำ ระบบจะส่งพิมพ์เมนูต้ม/ผัดไปที่ครัวร้อน และส่งเมนูเครื่องดื่มไปพิมพ์ที่บาร์น้ำโดยอัตโนมัติ ช่วยลดปัญหาพนักงานวิ่งส่งกระดาษบิล"
  },
  {
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-emerald-50/20 to-white py-20 px-4 sm:px-6 lg:px-8 font-sans">
        ...
        <div className="max-w-6xl mx-auto relative z-10 pt-10">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center mb-20">
            ...
            <div className="space-y-6">
              <h2 className="text-2xl font-bold text-slate-800">ยกระดับประสิทธิภาพด้วยระบบร้านอาหาร POS Foodscan</h2>
              <div className="space-y-4">
                {[
          ...
          <div className="grid md:grid-cols-2 gap-12 mb-20 bg-emerald-50/20 p-8 md:p-12 rounded-[2.5rem] border border-emerald-100/40">
            <div>
              ...
              <div className="space-y-6">
                {[
                  { step: "1", title: "สมัครสร้างผังโต๊ะของร้าน", desc: "ลงทะเบียนบัญชี POS Foodscan และตั้งค่าระบุจำนวนโต๊ะอาหารและโซนนั่งภายในร้าน" },
