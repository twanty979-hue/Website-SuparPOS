...
export default function TermsPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-emerald-50 to-white py-12 px-4 sm:px-6 lg:px-8 font-sans text-slate-600">
      ...
      {/* Background Decor */}
      <div className="fixed top-[-10%] left-[-10%] w-96 h-96 bg-emerald-100 rounded-full blur-[100px] opacity-40 pointer-events-none"></div>
      <div className="fixed bottom-[-10%] right-[-10%] w-96 h-96 bg-teal-100 rounded-full blur-[100px] opacity-40 pointer-events-none"></div>

      <div className="max-w-4xl mx-auto relative z-10">
        
        {/* Header Section */}
        <div className="text-center mb-10">
          <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-white shadow-lg shadow-emerald-500/10 mb-6 text-emerald-600 border border-emerald-50">
          ...
          <div className="p-8 md:p-12 space-y-10">
            ...
            <div className="grid gap-8">
              ...
              <div className="flex gap-4 items-start group">
                <div className="flex-shrink-0 w-10 h-10 rounded-full bg-slate-100 flex items-center justify-center text-slate-600 font-bold group-hover:bg-emerald-600 group-hover:text-white transition-colors">1</div>
                <div>
                  <h3 className="text-lg font-bold text-slate-800 mb-2 group-hover:text-emerald-600 transition-colors">การใช้งานบริการ</h3>
              ...
              {/* Item 2 */}
              <div className="flex gap-4 items-start group">
                <div className="flex-shrink-0 w-10 h-10 rounded-full bg-slate-100 flex items-center justify-center text-slate-600 font-bold group-hover:bg-emerald-600 group-hover:text-white transition-colors">2</div>
                <div>
                  <h3 className="text-lg font-bold text-slate-800 mb-2 group-hover:text-emerald-600 transition-colors">บัญชีผู้ใช้และความปลอดภัย</h3>
                  <p className="text-slate-600 text-sm md:text-base leading-relaxed">
              ...
              {/* Item 3 */}
              <div className="flex gap-4 items-start group">
                 <div className="flex-shrink-0 w-10 h-10 rounded-full bg-slate-100 flex items-center justify-center text-slate-600 font-bold group-hover:bg-emerald-600 group-hover:text-white transition-colors">3</div>
                <div>
              ...
              {/* Item 4 */}
              <div className="flex gap-4 items-start group">
                 <div className="flex-shrink-0 w-10 h-10 rounded-full bg-slate-100 flex items-center justify-center text-slate-600 font-bold group-hover:bg-emerald-600 group-hover:text-white transition-colors">4</div>
                <div>
              ...
              {/* Item 5 & 6 Combined */}
              <div className="flex gap-4 items-start group">
                 <div className="flex-shrink-0 w-10 h-10 rounded-full bg-slate-100 flex items-center justify-center text-slate-600 font-bold group-hover:bg-emerald-600 group-hover:text-white transition-colors">5</div>
                <div>
