...
export default function RefundPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-emerald-50 to-white py-12 px-4 sm:px-6 lg:px-8 font-sans text-slate-600">
      ...
      {/* Background Decor */}
      <div className="fixed top-[-10%] right-[-10%] w-96 h-96 bg-emerald-100 rounded-full blur-[100px] opacity-40 pointer-events-none"></div>
      <div className="fixed bottom-[-10%] left-[-10%] w-96 h-96 bg-teal-100 rounded-full blur-[100px] opacity-40 pointer-events-none"></div>
          ...
          <div className="p-8 md:p-12 space-y-10">
            ...
            <div className="grid gap-8">
              ...
              <div className="flex gap-4 items-start group">
                ...
                <div>
                  <h3 className="text-lg font-bold text-slate-800 mb-2 group-hover:text-emerald-600 transition-colors">ข้อยกเว้นในการคืนเงิน (Exceptions)</h3>
              ...
              <div className="flex gap-4 items-start group">
                ...
                <div>
                  <h3 className="text-lg font-bold text-slate-800 mb-2 group-hover:text-emerald-600 transition-colors">ขั้นตอนการขอคืนเงิน</h3>
                  <p className="text-slate-600 text-sm md:text-base leading-relaxed">
              ...
              <div className="flex gap-4 items-start group">
                ...
                <div>
                  <h3 className="text-lg font-bold text-slate-800 mb-2 group-hover:text-emerald-600 transition-colors">การยกเลิกบริการ (Cancellation)</h3>
                  <p className="text-slate-600 text-sm md:text-base leading-relaxed">
