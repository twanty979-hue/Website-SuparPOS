    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-emerald-50/30 to-white py-20 px-4 sm:px-6 lg:px-8 font-sans">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-start max-w-5xl mx-auto">
          ...
          {/* 2. BASIC Plan */}
          <div className="bg-white rounded-3xl p-6 border border-emerald-200 shadow-lg shadow-emerald-200/50 hover:shadow-xl transition-all duration-300 h-full flex flex-col">
            <div className="mb-6 text-center">
            ...
            <Link 
              ...
              className="w-full block text-center py-2.5 rounded-xl bg-emerald-50 text-emerald-600 font-bold hover:bg-emerald-100 transition-colors"
            >
              เลือกแพ็กเกจนี้
            </Link>
          </div>

          {/* 3. PRO Plan (Best Seller) */}
          <div className="bg-white rounded-3xl p-6 border-2 border-emerald-500 shadow-2xl shadow-emerald-500/20 relative transform md:-translate-y-4 h-full flex flex-col z-10">
             {/* Badge */}
            <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-gradient-to-r from-emerald-600 to-teal-500 text-white text-xs font-bold px-4 py-1.5 rounded-full shadow-lg whitespace-nowrap">
              ขายดีที่สุด
            </div>
            ...
            <Link 
              ...
              className="w-full block text-center py-3.5 rounded-xl bg-gradient-to-r from-emerald-600 to-teal-500 text-white font-bold hover:from-emerald-700 hover:to-teal-600 shadow-lg shadow-emerald-500/30 transition-all hover:scale-[1.02]"
            >
              เลือกแพ็กเกจนี้
            </Link>
          </div>
