...
export const metadata: Metadata = {
  title: "โปรแกรมร้านกาแฟและระบบ POS คาเฟ่ | POS Foodscan",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "โปรแกรมร้านกาแฟและระบบ POS คาเฟ่ | POS Foodscan",
      },
    ],
  },
  twitter: {
...
const CAFE_FAQS = [
  {
    ...
    answer: "คุณสามารถกำหนดสูตรสินค้า (Recipe) ให้กับแต่ละเครื่องดื่มได้ เช่น ลาเต้เย็น ใช้เมล็ดกาแฟ 18 กรัม และนมสด 120 มล. เมื่อแคชเชียร์กดขายรายการนี้ ระบบของ POS Foodscan จะทำการหักลบจำนวนเมล็ดกาแฟและนมสดออกจากสต๊อกคลังวัตถุดิบให้โดยอัตโนมัติทันที"
  },
  {
  ...
  },
  {
    ...
    answer: "POS Foodscan รองรับการเชื่อมต่อเครื่องพิมพ์ใบเสร็จและใบออเดอร์ผ่านบลูทูธหรือวงแลน โดยคุณสามารถตั้งค่าแยกประเภทเครื่องพิมพ์ได้ เช่น ออเดอร์เครื่องดื่มพิมพ์ออกที่บาร์น้ำ และออเดอร์เบเกอรี่พิมพ์ออกที่ครัวเตาอบแยกกันโดยอัตโนมัติ"
  }
];
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-emerald-50/20 to-white py-20 px-4 sm:px-6 lg:px-8 font-sans">
        ...
        <div className="max-w-6xl mx-auto relative z-10 pt-10">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center mb-20">
            ...
            <div className="space-y-6">
              <h2 className="text-2xl font-bold text-slate-800">แก้ปัญหาอย่างตรงจุดด้วย POS Foodscan</h2>
              <div className="space-y-4">
                {[
          ...
          <div className="grid md:grid-cols-2 gap-12 mb-20 bg-emerald-50/20 p-8 md:p-12 rounded-[2.5rem] border border-emerald-100/40">
            <div>
              ...
              <div className="space-y-6">
                {[
                  { step: "1", title: "ลงทะเบียนร้านค้าฟรี", desc: "เข้าสมัครใช้งานระบบ POS Foodscan ผ่านหน้าเว็บไซต์ ได้ร้านค้าออนไลน์ของคุณทันที" },
